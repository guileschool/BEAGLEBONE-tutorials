...
static int
omapl1xx_get_corefuncs_sw(disp_adapter_t *context,
    unsigned pixel_format, disp_draw_corefuncs_t *funcs, int tabsize)
{
	return ffb_get_corefuncs(context, pixel_format, funcs, tabsize);
}
...
devg_get_miscfuncs(disp_adapter_t *adp, disp_draw_miscfuncs_t *funcs, int tabsize)
{
	...
	DISP_ADD_FUNC(disp_draw_miscfuncs_t, funcs, get_corefuncs_sw, omapl1xx_get_corefuncs_sw, tabsize);
